...
if __name__ == "__main__":
    img_dir  = "/workspace/torchao/"
    num_eval_images = 10
    # img1_path = "/workspace/Image-Optimization/image_server/images/flux-schnell-text-to-image/0_torchao_5.jpg"
    # img2_path = "/workspace/Image-Optimization/image_server/images/flux-schnell-text-to-image/2_torchao_5.jpg"
    for i in range(num_eval_images):
        img1_path = os.path.join(img_dir, f'origin_schnell{i}.png')
        img2_path = os.path.join(img_dir, f'torchao{i}.png')
        ...
        print(f"Final score prompt {i}: {score**2}")
